//
//  OpenJsonTokenJS.swift
//  Smart ID Card
//
//  Created by Sushant Giri on 30/06/2021.
//

import Foundation
import JavaScriptCore

open class OpenJsonTokenJs {
    
    lazy var context: JSContext? = {
        let context = JSContext()
        
        guard let
                JSONTokenJSPath = Bundle.main.path(forResource: "jsontokens", ofType: "js") else {
